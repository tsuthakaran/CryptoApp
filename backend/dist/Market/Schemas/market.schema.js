...
let Market = class Market extends mongoose_2.Document {
    listOfAvailableCurrencies;
};
exports.Market = Market;
__decorate([
    (0, mongoose_1.Prop)({ type: [currency_schema_1.CurrencySchema], default: [] }),
    __metadata("design:type", Array)
], Market.prototype, "listOfAvailableCurrencies", void 0);
