...
import TransactionButtons from "@/components/bryan-portfolio/main/transaction-button"

function PortfolioPriceGraph() {
      ...
      <div className="flex justify-between items-start mb-4">
        ...
        <div className="flex items-center gap-4">
          {selectedCrypto === 'TOTAL' ? (
            <ScrollArea className="h-[100px] w-[200px] rounded-md border border-[#F0E7A1]/20">
              <div className="p-4">
                {cryptoData
                  .filter(crypto => crypto.value > 0)
                  .map(crypto => (
                    <div key={crypto.symbol} className="flex justify-between items-center mb-2">
                      <span className="text-[#F0E7A1]">{crypto.symbol}</span>
            ...
            <div className="text-xl font-semibold text-[#F0E7A1]">
...
export default PortfolioPriceGraph; 